...
if __name__ == '__main__':
    ...
    text_path = DATA_ROOT + DATASET + "/train_texts.txt"
    label_path = DATA_ROOT + DATASET + "/train_labels.txt"
    vocab_path = DATA_ROOT + DATASET + "/vocab.npy"
    emb_path = DATA_ROOT + DATASET + "/emb_init.npy"
    w2v_path = DATA_ROOT + "glove.840B.300d.gensim"
    main(text_path=text_path, label_path=label_path, vocab_path=vocab_path, emb_path=emb_path, w2v_model=w2v_path)

    text_path = DATA_ROOT + DATASET + "/test_texts.txt"
    label_path = DATA_ROOT + DATASET + "/test_labels.txt"
    vocab_path = DATA_ROOT + DATASET + "/vocab.npy"
    main(text_path=text_path, label_path=label_path, vocab_path=vocab_path)
